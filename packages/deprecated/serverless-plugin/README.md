...
Check it out [here](https://github.com/sleukhin/serverless-next.js/tree/master/packages/serverless-components/nextjs-component). As you can see, it lives in the same monorepo.
The new version has feature parity with nextjs 9.0 and does not use CloudFormation, allowing faster deployments and no [resource limit issues](https://github.com/sleukhin/serverless-next.js/issues/17).
...
`npm install --save-dev @savaleukhin/serverless-plugin`
...
Beware this plugin relies on CloudFormation which has a hard limit of 200 resources. If you have a large number of pages in your application it is very likely that you will hit this limit. Use https://github.com/sleukhin/serverless-next.js/tree/master/packages/serverless-components/nextjs-component which solves this problem by not using CloudFormation.
...
<a href="https://github.com/sleukhin/serverless-next.js/tree/master/packages/deprecated/serverless-plugin/graphs/contributors"><img src="https://opencollective.com/serverless-nextjs-plugin/contributors.svg?width=890&button=false" /></a>
