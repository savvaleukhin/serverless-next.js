...
import { AwsPlatformClient } from "@savaleukhin/aws-common";
import { httpCompat } from "src/compat/apigw";
import {
  APIGatewayProxyEventV2,
  APIGatewayProxyStructuredResultV2
} from "aws-lambda";
import { ImagesManifest, setCustomHeaders } from "@savaleukhin/core/dist/module";
import url, { UrlWithParsedQuery } from "url";
import { LambdaManifest, RoutesManifest } from "src/types";
import {
  imageOptimizer,
  normaliseUri
} from "@savaleukhin/core/dist/module/images";
